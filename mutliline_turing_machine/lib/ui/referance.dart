...
Таким образом, если в состоянии записаны команды “1 2 >” и “1 3 >”, то при нахождении на ленте символа “1” выполнится команда “1 2 >” так как оно находится выше в списке команд чем “1 3 >”."""),
                        subTitle("Управление Машиной Тьюринга"),
                        text(
                            """Машина Тьюринга может работать как  ручном, так и в автоматическом режиме. При ручном режиме для выполнения шага необходимо нажать кнопку “Сделать шаг” на нижней панели инструментов. Автоматический режим подразумевает выполнение шагов машиной без действий со стороны пользователя. Для перехода в автоматический режим нужно нажать на кнопку “Автоматическая работа” в нижней панели. Чтобы выйти из автоматического режима необходимо нажать повторно на эту кнопку.

У автоматического режима можно настраивать скорость. Нажав на кнопку изменения скорости рядом с кнопкой “Автоматическая работа” появится всплывающий список, в котором можно выбрать желаемую скорость.
...
Чтобы остановить выполнение машины и сбросить текущее состояние нужно нажать на кнопку “Стоп” на нижней панели инструментов."""),
                        ...
                        text(
                            """Каждая команда, вводимое в таблицу команд представляет собой 3 символа в формате “0 1 >”, где “0”- заменяемый символ, “1” - заменяющий символ, а “>” - направление движения головки.
...
Для взаимодействия со всеми ячейками команды можно выделить их, нажав Ctrl и кликнув на нужную команду, после чего аналогично с копированием ячейки можно копировать сразу всю команду. 

Порядок команд можно изменять. Для этого нужно нажать на 6 точек возле номера команды и потянуть ее на желаемое место. Так же выделив несколько команд можно перемещать их все одновременно."""),
